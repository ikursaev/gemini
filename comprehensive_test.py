...
class DocumentExtractorTester:
    ...
    def test_health_endpoints(self) -> bool:
        ...
        try:
            ...
            self.log_test("Basic Health Check", basic_health, f"Status: {response.status_code}")
        ...
        try:
            ...
            self.log_test("Detailed Health Check", detailed_health, 
    ...
    def test_frontend_serving(self) -> bool:
        ...
        try:
            ...
            success = (
                ...
                "Document Extractor" in response.text
            )
            self.log_test("Frontend Serving", success, 
    ...
    def test_tasks_api_endpoint(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.log_test("Tasks API Structure", success, 
    ...
    def test_file_upload_validation(self) -> bool:
        ...
        try:
            ...
            with open(test_file, 'rb') as f:
                ...
                response = self.session.post(f"{self.base_url}/uploadfile/", files=files)
            ...
            self.log_test("File Type Validation", success, 
    ...
    def test_task_metadata_persistence(self, task_id: str) -> bool:
        ...
        try:
            ...
            if success:
                tasks = response.json()
                our_task = next((task for task in tasks if task.get("task_id") == task_id), None)
    ...
    def test_task_status_monitoring(self, task_id: str, max_wait: int = 30) -> Dict[str, Any]:
    ...
    def run_comprehensive_tests(self) -> Dict[str, Any]:
        ...
        if upload_result["success"]:
            ...
            if task_id:
                ...
                monitoring_result = self.test_task_status_monitoring(task_id, max_wait=60)
...
def main():
    ...
    if results["success_rate"] >= 0.8:  # Allow 80% pass rate for complex system
        ...
        logger.error(f"⚠️ Too many tests failed! Success rate: {results['success_rate']*100:.1f}%")
        exit(1)
